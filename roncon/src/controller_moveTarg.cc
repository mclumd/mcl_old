...
bool controllers::move_to_target::start() {
  return start(_controller_movetarg_defaults);
}

bool controllers::move_to_target::start(arguments& cargo) {
  player_controller::start(cargo);
