...
/* sensor codes   */
  ...
  symbol_def("sc_actor",SC_ACTOR);
  symbol_def("sc_object",SC_OBJECT);
  symbol_def("sc_goalscene",SC_GOALSCENE);
  symbol_def("sc_mainresult",SC_MAINRESULT);
  symbol_def("sc_opponent",SC_OPPONENT);
  symbol_def("sc_charge",SC_CHARGE);
  symbol_def("sc_to",SC_TO);
  symbol_def("sc_itemlocation",SC_ITEMLOCATION);
