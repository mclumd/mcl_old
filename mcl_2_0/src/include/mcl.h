...
class mcl : public mclEntity {
 public:
  ...
  void setOntologyBase(string ont);
  ...
  void add_obs_legalval(string obsname,double v)
    { my_ov->add_obs_legalval(obsname,v); };
  void add_obs_legalval(string objnm,string obsnm,double v)
    { my_ov->add_obs_legalval(objnm,obsnm,v); };
  void set_obs_legalrange(string obsname,double low, double high)
    { my_ov->set_obs_legalrange(obsname,low,high); };
  void set_obs_legalrange(string objnm,string obsnm,double low, double high)
    { my_ov->set_obs_legalrange(objnm,obsnm,low,high); };
