 ...
 */
 ...
 public:
   ...
   void add_obs_legalval(string oname,double lval);
   void set_obs_legalrange(string oname,double l, double h);
   void add_obs_legalval(string o_type_name,string obsname,double lval);
   void set_obs_legalrange(string o_type_name,string obsname,
			   double l, double h);
