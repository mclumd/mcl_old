...
#define CRC_SOLICIT_HELP 13
#define CRC_RELINQUISH_CONTROL 14
#define CRC_SENSOR_DIAG 15
#define CRC_EFFECTOR_DIAG 16
#define CRC_SENSOR_RESET 17
#define CRC_EFFECTOR_RESET 18
#define CRC_ACTIVATE_LEARNING 19
#define CRC_ADJ_PARAMS 20
#define CRC_REBUILD_MODELS 21
#define CRC_REVISIT_ASSUMPTIONS 22
#define CRC_AMEND_CONTROLLER 23
#define CRC_REVISE_EXPECTATIONS 24
#define CRC_ALG_SWAP 25
#define CRC_CHANGE_HLC 26
#define CRC_RESCUE 27
#define CRC_GIVE_UP 28

#define CRC_EXTENDED_CODE 29

#define CRC_PCV_MAXINDEX 30
...
/* maintenance */
#define EC_STAYUNDER 0
#define EC_STAYOVER 1
#define EC_MAINTAINVALUE 2
#define EC_WITHINNORMAL 3

#define EC_REALTIME 4
#define EC_TICKTIME 5

/* effects     */
#define EC_GO_UP 6
#define EC_GO_DOWN 7
#define EC_NET_ZERO 8
#define EC_ANY_CHANGE 9
#define EC_NET_RANGE 10
#define EC_TAKE_VALUE 11
