...
namespace mclMA {
   ...
   */
  bool configureMCL(string key, string domain);
  bool configureMCL(string key, string domain, string agent);
  bool configureMCL(string key, string domain,string agent,string controller);
   ...
   * \param referent a frame referent provided in an mclMonitorResponse
   */
  void suggestionFailed(string key,resRefType referent);
  ...
  namespace observables {
    ...
    void add_obs_legalval(string mclkey,string objname,string obsname,
			  double lval);
    void set_obs_legalrange_self(string mclkey,string obsname,
				 double low,double high);
    void set_obs_legalrange(string mclkey,string objname,string obsname,
			    double low,double high);
