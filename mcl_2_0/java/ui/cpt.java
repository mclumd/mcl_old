...
public class cpt {
    ...
    public static void loadCPTconfig(String sys) {
        BufferedReader pro_file = null;
        try {
	    String fn = System.getenv("MCL_CORE_PATH")+"config/"+sys+"/cp_tables.mcl";
    ...
    public static void main(String[] arg) {
        BufferedReader pro_file = null;
        try {
	    String fn = System.getenv("MCL_CORE_PATH")+"config/default/cp_tables.mcl";
            pro_file = new BufferedReader(new FileReader(fn));
	    String sline = pro_file.readLine();
	    while (sline != null) {
		cpt k = new cpt(sline,fn);
