...
namespace mcMars {
  ...
  class rugpa_opportunistic_layer : public MonCon::has_action_q, public MonCon::reactive_layer {
  public:
    rugpa_opportunistic_layer(controller* inna);
    virtual ~rugpa_opportunistic_layer() {};
    ...
    virtual string class_name() { return "rugpa_opportunistic_layer"; };
    virtual string describe() 
    { return "(rugpa_opportunistic_layer wraps"+peel()->describe()+")"; };
